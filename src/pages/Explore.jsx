...
const Explore = () => {
  ...
  return (
    <div className=' w-full h-screen pt-16 bg-black overflow-x-hidden'>

    <div className='w-full h-full overflow-y-scroll overflow-x-hidden custom-scrollbar'>
        ...
        <div className='bg-transparentmb-8 w-full'>
            <div className='font-poppins font-medium text-white px-10 flex justify-between'>
                <div>
                Users
                </div>
